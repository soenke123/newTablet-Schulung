      ...
      btn.addEventListener('click', function () {
        ...
        if (scr === 'intro') {
          ...
          RT.state.dispatch('RESTORE_STATE', {
            phase: 'garage', month: 0, goLiveUnlocked: false, player: player,
            resources: { money: 1000, users: 0, serverCapacity: 3000, serverUsage: 0,
                         workers: { occupied: 0, max: 1 } },
          ...
          RT.state.dispatch('RESTORE_STATE', {
            phase: 'campus', month: 4, goLiveUnlocked: true, player: player,
            ...
            pendingCelebrations: [], userGrowthRate: 0.15,
            reputation: 0.02,
            meta: { gameStarted: true, gameEnded: false,
          ...
          RT.state.dispatch('RESTORE_STATE', {
            ...
            player: player,
            resources: {
              money: 100000, users: 505000,
              serverCapacity: 610000, serverSoftwareUsage: 19400, serverUsage: 505000,
              workers: { occupied: 2, max: 5, capacity: 6 }
            },
            buildings: [
              { type: 'werbeagentur',    slot: 1, level: 0, upgraded: false, workerAssigned: false },
              { type: 'marketingstudio', slot: 2, level: 0, upgraded: false, workerAssigned: false },
              { type: 'serverfarm',      slot: 3, level: 1, upgraded: true,  workerAssigned: true  },
              { type: 'serverfarm',      slot: 4, level: 1, upgraded: true,  workerAssigned: true  },
              { type: 'buero',           slot: 5, level: 0, upgraded: false, workerAssigned: false },
              { type: 'buero',           slot: 6, level: 0, upgraded: false, workerAssigned: false }
            ],
            research: {},
            purchases: { server1: true, rechner: true },
            techtree: {
