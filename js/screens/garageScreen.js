...
(function (RT) {
  ...
  function enter(container) {
    ...
    container.innerHTML = ''
      ...
      + '      <div class="rt-hq-progress-wrap rt-hq-progress--idle" id="rt-hq-progress-wrap">'
      + '        <span class="rt-hq-progress-icon" id="rt-hq-progress-icon"></span>'
      + '        <div class="rt-hq-progress-right">'
      + '          <span class="rt-hq-progress-name" id="rt-hq-progress-name"></span>'
      + '          <div class="rt-hq-progress-track"><div class="rt-hq-progress-bar" id="rt-hq-progress-bar"></div></div>'
      + '          <span class="rt-hq-progress-label" id="rt-hq-progress-label"></span>'
      + '        </div>'
      + '      </div>'
