...
(function (RT) {
  ...
  var AVATARS = {
    fuchs:         { body: 'Fuch.png',         head: 'FuchsHead.png',         label: 'Fuchs' },
    otter:         { body: 'Otter.png',        head: 'OtterHead.png',         label: 'Otter' },
    waschbaer:     { body: 'Waschbär.png',     head: 'WaschbärHead.png',      label: 'Waschbär' },
    eichhoernchen: { body: 'Eichhörnchen.png', head: 'EichhörnchenHead.png',  label: 'Eichhörnchen' }
  };

  var LOGOS = {
    bell:    { file: 'Logo1.png', niceFile: 'Logo1nice.png', label: 'Glocke' },
    connect: { file: 'Logo2.png', niceFile: 'Logo2nice.png', label: 'Connect' },
    rocket:  { file: 'Logo3.png', niceFile: 'Logo3nice.png', label: 'Rakete' },
    graph:   { file: 'Logo4.png', niceFile: 'Logo4nice.png', label: 'Graph' },
    trend:   { file: 'Logo5.png', niceFile: 'Logo5nice.png', label: 'Trend' },
    chat:    { file: 'Logo6.png', niceFile: 'Logo6nice.png', label: 'Plausch' },
    like:    { file: 'Logo7.png', niceFile: 'Logo7nice.png', label: 'Like' },
    mesh:    { file: 'Logo8.png', niceFile: 'Logo8nice.png', label: 'Netz' }
  };
  ...
  var BUILDINGS = {
    ...
    serverfarm:      { stages: ['Serverfarm.png'],         label: 'Server-Farm'      },
