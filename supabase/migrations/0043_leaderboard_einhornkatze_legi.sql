-- ══════════════════════════════════════════════════════════════
-- Migration 0043 — Einhornkatze in Legi-Rangliste aufnehmen
-- ══════════════════════════════════════════════════════════════
-- Bug: Die Einhornkatze (Season-3 Team-Legi) wurde clientseitig
-- längst als Legendary geführt (creatures.js:LEGENDARY_CREATURES),
-- aber die Server-RPC get_hub_leaderboard filterte den
-- 'legendaries'-Zweig immer noch nur auf die 4 alten Legis
-- (robot, pfau, chinDrache, schnabeltier). Ergebnis: Wer die
-- Einhornkatze bereits gesammelt hatte, sah sie im Book of Monsters
-- als Legi, wurde in der Highscoreliste „Legendäre Tiere" aber
-- nicht dafür angerechnet.
--
-- Das „Monster"-Board zählt weiterhin alle Kreaturen inkl. aller
-- Legendaries — konsistent mit dem bestehenden Verhalten der 4
-- alten Legis.
--
-- Basis: Migration 0033 (bonbons-Metric). Nur die beiden
-- Legi-Filter im scored-CTE sind erweitert.
-- ══════════════════════════════════════════════════════════════
