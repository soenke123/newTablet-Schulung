...
(function (RT) {
  ...
  // v3: Team-Stufen-Refactor — inkompatibel mit v2-Saves. Alte Saves werden ignoriert
  //     und das Spiel startet frisch (Solo, keine Mitarbeiter, kein Büro).
  var KEY = 'rt_startup_v3';

  // Felder die gespeichert werden (alles außer temporären UI-Dingen).
  var SAVE_FIELDS = [
    'phase', 'month', 'goLiveUnlocked', 'player', 'teamStufe',
    'resources', 'buildings', 'research', 'purchases',
    'techtree', 'pendingCelebrations', 'userGrowthRate', 'reputation',
    'campaigns', 'meta', 'werbeagentur', 'marcusDealAccepted', 'supportProgram',
    'transactions', 'sparkHistory', 'ccState',
    'metadatenActive', 'metadatenPendingActivation', 'metadatenWorkSlot', 'watchtime', 'marketExpansions',
    'expansionStartMonth', 'werbekriseActive', 'storyLog'
  ];
